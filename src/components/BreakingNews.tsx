    ...
    if (values.length > 0) {
        return (
            <footer className="bg-red-600 text-white mt-4">
                <div className="w-100 px-2 flex flex-col h-48 overflow-hidden">
                    <h3 className="text-4xl pb-2 uppercase">Breaking news</h3>
                    <p className={`text-2xl py-2 ${animationDuration} flex`}>
