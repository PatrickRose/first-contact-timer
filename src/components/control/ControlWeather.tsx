...
export function ControlWeather({setAPIResponse, setError, weatherMessage, id}: {
    setAPIResponse: (apiResponse: ApiResponse) => void,
    setError: (value: (((prevState: (string | undefined)) => (string | undefined)) | string | undefined)) => void,
    ...
    return <div
        className="container lg:p-4 pb-24 lg:pb-4 lg:bg-gradient-to-b from-turn-counter-past-light to-turn-counter-past-dark">
        <h2 className="text-3xl mt-2 mb-6 uppercase text-center">
            Weather Status
        </h2>
        <h3 className="text-2xl">Current Weather Status</h3>
        <div className="flex flex-col">
            <WeatherStatus message={weatherMessage === "" ? "No weather message" : weatherMessage}/>
        </div>
            ...
            <form onSubmit={submit} className="mt-2">
                ...
                <div className="block">
                            <textarea
                                ...
                                onChange={(e) => setNewWeatherMessage(e.target.value)}
                                rows={4}
                                maxLength={150}
                            />
                    <button
